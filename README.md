...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ovdpk9i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ovdpk9i.containers.anotherwebservice.com/
...
```
git clone git@github.com:tomhut25/container-ovdpk9i.git
cd container-ovdpk9i
```
...
```
docker attach container-ovdpk9i
```
